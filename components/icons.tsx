...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 3.13a4 4 0 010 7.75L16 11H8a4 4 0 010-7.75L8 3h8z" />
    </svg>
);
...
export const HeartIcon: React.FC<{ className?: string; solid?: boolean }> = ({ className, solid }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill={solid ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
